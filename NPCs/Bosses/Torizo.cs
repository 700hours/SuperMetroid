...
namespace SuperMetroid.NPCs.Bosses
{
	public class Torizo : ModNPC
	{
		...
		#region bombs
			...
			if(npc.life <= 30)
			{
				...
				{
					Dust.NewDust(npc.position, (int)npc.width/2+32, npc.height/4+16, dustID, npc.velocity.X * 0.2f, npc.velocity.Y * 0.2f, 100, Color.White, dustScale);
				}
			}
	...
	//	}
		public override void NPCLoot()
		{
			...
			int maxMissiles = modPlayer.missileUpg;
